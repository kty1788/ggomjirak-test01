	...
	$("#messagesDropdown").click(function() {
		...
		$.get(url, function(rData) {
			...
			$.each(rData, function() {
				...
				cloneItem.find(".text-gray-500").text(this.msg_senddate);
				cloneItem.removeAttr("id");
				cloneItem.addClass("list-item");
				cloneItem.insertAfter($("#msgItem"));
				// ->같은 코드 $("#msgItem").after(cloneItem);
				cloneItem.show();
			})
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                 ...
                 <c:choose> 
                       <c:when test="${empty sessionScope.loginVo }">
                       	<div>
                       		<a href="/loginForm" class="btn btn-sm btn-success">로그인</a>
                       		<a href="/memberJoinForm" class="btn btn-sm btn-warning">회원가입</a>
                       	</div>
                       </c:when>
                       <c:otherwise>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#" style="display:none" id="msgItem">
...
<!--                                     </div> -->
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="/message/messageListReceive">받은 쪽지함으로 가기</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                               ...
                               ${sessionScope.loginVo.user_name }(${sessionScope.loginVo.user_id }) - [ ${sessionScope.loginVo.user_point } 포인트]
                                </span>
